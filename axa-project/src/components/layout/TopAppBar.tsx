...
export function TopAppBar({ onMenuClick, isMobile }: TopAppBarProps) {
  ...
  return (
    <header className="flex justify-between items-center w-full px-4 md:px-8 h-16 bg-surface sticky top-0 z-40 font-headline">
      <div className="flex items-center gap-4">
        {isMobile && (
          <button
            onClick={onMenuClick}
            className="p-2 text-zinc-500 hover:text-zinc-300 hover:bg-surface-container-highest rounded transition-colors"
          >
